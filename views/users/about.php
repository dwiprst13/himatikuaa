...
<section class="bg-gray-900">
    <div class="w-[95%] mx-auto md:w-[90%] rounded-2xl p-3 md:p-5 space-y-10">
        ...
        <div data-aos="fade-up" data-aos-duration="1500" class="my-10 space-y-5 text-white">
            ...
            <div class=" text-center py-5 space-y-[1rem]">
                <p class="text-[1rem] md:text-[1.1rem] lg:text-[1.2rem] text-justify">
                    <span class="text-blue-600">Kode</span> diartikan sebagaibahsa pemrograman, yang merupakan alat utama dalam pengembangan software, aplikasi dan berbagai solusi berbasis teknologi. penggunaan kata "Kode" menggambarkan fokus organisasi pada bidang pemrograman dan teknologi informatika.
                </p>
                <p class="text-[1rem] md:text-[1.1rem] lg:text-[1.2rem] text-justify">
        ...
        <div data-aos="fade-up" data-aos-duration="1500" class="my-10 space-y-5 text-white">
            ...
            <div class="flex flex-col space-y-4 md:space-y-0 md:flex-row gap-5 md:gap-3">
                ...
                <div class="w-full md:w-1/2 p-5">
                    ...
                    <table class="w-full space-y-3 text-white">
                        <tr>
